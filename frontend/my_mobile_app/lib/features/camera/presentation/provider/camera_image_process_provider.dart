...
final cameraImageProcessProvider =
...
class CameraNotifier extends StateNotifier<CameraState> {
  ...
  void updateImage (XFile? image) {
    state = state.copyWith(image: image, verificationCompleted: false);
  }
...
class CameraState {
  ...
  const CameraState(this.probability, this.condition, this.verificationCompleted, this.currentActionIndex, this.image);

  factory CameraState.initial() => const CameraState(null, null, false, 0, null);
