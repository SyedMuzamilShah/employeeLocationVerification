          ...
          children: [
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, index) {
                  ...
                  return FilterChip(
                    ...
                    onSelected: (_) {
                      paramsNotifier.state =
                          currentParams.copyWith(status: value);
                    },
                  );
                },
              ),
            ...
            Expanded(
              child: state.when(
                ...
                data: (list) {
                  if (list.isEmpty) {
                    int? assignedIndex = currentParams.status?.index;
                    ...
                    if (assignedIndex == 1) {
                      return Column(
                        ...
                        children: [
                          ...
                          const Center(
                              child: Text('No Task Assignments Found')),
                        ],
                      );
                    }
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        const Center(
                            child: Text(
                                'No task assignment found in this category')),
                      ],
                    );
                  }
                          ...
                          trailing: Column(
                            ...
                            children: [
                              if (assignment.submittedAt != null)
                                Text('Submitted: ${showTimeInFormattedFunction(assignment.submittedAt!)}'),
                              if (assignment.submittedAt != null)
                                Text('Is Late: ${assignment.submittedLate}'),
                              if (assignment.confidence != null)
                                Text('Confidence: ${assignment.confidence?.toInt()}%'),
                            ],
                          ),
                        ),
                      );
