...
import 'package:my_desktop_app/features/task/presentation/widgets/map_view_selection_widget.dart';

class AddressSearchView extends ConsumerStatefulWidget {
  final TaskCreateParamsNotifier taskParamsNotifier;
  const AddressSearchView({super.key, required this.taskParamsNotifier});

  @override
  ConsumerState<AddressSearchView> createState() => _AddressSearchViewState();
}

class _AddressSearchViewState extends ConsumerState<AddressSearchView> {
